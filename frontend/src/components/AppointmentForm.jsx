...
const AppointmentForm = () => {
  ...
  //when form is submitted redirect to home page
  const navigateTo = useNavigate()

  //to get all doctors that are registered
  //run this function when page is refreshed
      ...
      <div 
       style={ {gap:"10px" , justifyContent:"flex-end",
        ...
        <p style={{marginBottom:0}}>Have you visited before?</p>
          <input type="checkbox" value={hasVisited} onChange={(e)=>setHasVisited(e.target.checked)} 
